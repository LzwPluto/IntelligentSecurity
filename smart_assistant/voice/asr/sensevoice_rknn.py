...
def recognize(audio_file, download_path, device, num_threads, language, use_itn):
...
if __name__ == "__main__":
    args = parse_args()
    recognize(args.audio_file, args.download_path, args.device, args.num_threads, args.language, args.use_itn)
